...
void CmndWebcamGetPicStore(void) {
  ...
  AddLog(LOG_LEVEL_DEBUG, PSTR("CAM: PicStore buffer %d at 0x%x"), bnum, t);

  char resp[50] = "0";
  snprintf_P(resp, sizeof(resp), PSTR("{\"buff\":%d,\"addr\":%d,\"len\":%d}"), bnum, t, res);
